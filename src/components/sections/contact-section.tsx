        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <p className="font-mono text-xs text-foreground/60 md:text-base">/ Мы приедем быстро</p>
            </div>

            <div className="space-y-4 md:space-y-8">
              <a
                href="tel:+79954946012"
              ...
              >
                <div className="mb-1 flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs text-foreground/60">Телефон (круглосуточно)</span>
                </div>
              ...
              >
                <div className="mb-1 flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs text-foreground/60">Работаем по всему городу</span>
                </div>
                <p className="text-base text-foreground md:text-2xl">Выезд в любой район</p>
              </div>
